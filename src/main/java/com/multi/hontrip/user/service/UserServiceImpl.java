...
public class UserServiceImpl implements UserService{   //사용자 회원처리
    ...
    @Override
    public WithdrawUserDTO getSoicalIdbyId(WithdrawUserDTO withdrawUserDTO) {
        return userDAO.findProviderAndSocialIDById(withdrawUserDTO.getId());
    }

    @Override
    public String quiteSocial(WithdrawUserDTO withdrawUserDTO) {
